...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Archit Aggarwal — Growth Marketing Consultant for Luxury & D2C Brands" },
      { name: "description", content: "Independent growth and performance marketing consultant partnering with luxury, fashion, jewellery, and lifestyle brands to turn ad spend into revenue." },
